...
\\\\
\begin{enumerate}
    \item[{F}1.] Medición de la acústica actual
    \begin{enumerate}
        \item[{C}1.] El sistema debe generar un sonido en el estudio de audio.
    ...
    \begin{enumerate}
        \item[{C}1.] El sistema debe conocer la diferencia entre la acústica actual y la acústica deseada.
...
%----------------1------------------
    ...
    \begin{enumerate}
        \item[{1.}1.] Generación de onda de sonido
        \begin{enumerate}
            \item[{1.1.}1.] Selección de ondas necesarias
        ...
        \begin{enumerate}
            \item[{1.2.}1.] Sensado de la respuesta
        \end{enumerate}   

        \item Procesamiento de la respuesta
        \begin{enumerate}
            \item[{1.3.}1.] Cálculo de los parámetros acústicos
            \begin{enumerate}
                \item[{1.3.1.}1.] Cálculo del tiempo de reverberación
            ...
            \begin{enumerate}
                \item[{1.3.2.}1.] Obtención de dimensiones del estudio de audio
...
%----------------2------------------
    \item Modificación de la acústica
    \begin{enumerate}
        \item[{2.}1.] Cálculo de posiciones deseadas
        \item Compensación para disminución de modos normales de vibración
        
        \item Movimiento de paneles
        \begin{enumerate}
            \item[{2.3.}1.] Medición del error de posición
            \begin{enumerate}
                \item[{2.3.1.}1.] Medición de la posición actual
...
%----------------3------------------   
    \item Interacción con el usuario
    \begin{enumerate}
        \item[{3.}1.] Recepción de instrucciones de acondicionamiento
        \begin{enumerate}
            \item[{3.1.}1.] Selección de instrumento
            \begin{enumerate}
                \item[{3.1.1.}1.] Despliegue de acústica ideal
            \end{enumerate}
        \end{enumerate}

        \item Despliegue de acústica actual
        \begin{enumerate}
            \item[{3.2.}1.] Despliegue de las variables acústicas calculadas
        ...
        \begin{enumerate}
            \item[{3.3.}1.] Despliegue de las variables acústicas calculadas
...
%----------------4------------------
    \item Gestión de energía
    \begin{enumerate}
        \item[{4.}1.] Conversión y regulación de tensión
        \begin{enumerate}
            \item[{4.1.}1.] Conversión de tensión
            \item Regulación de tensión
        \end{enumerate}

        \item Medición del consumo energético
        \begin{enumerate}
            \item[{4.2.}1.] Medición de la tensión de entrada
            \item Medición de la corriente de entrada
        \end{enumerate}

        \item Gestión del consumo energético
        \begin{enumerate}
            \item[{4.3.}1.] Disminución de la potencia proporcional al consumo
        \end{enumerate}
