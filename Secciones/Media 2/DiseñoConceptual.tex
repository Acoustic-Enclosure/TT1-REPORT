...
\\ 
Funci\'on principal: Hacer un acondicionamiento acústico a un cuarto en función de la acústica óptima para un cierto instrumento.
\\\\
\begin{enumerate}[{F}1.]
...
%----------------1------------------
    ...
    \begin{enumerate}[{1.}1.]
        ...
        \item Obtenci\'on de la respuesta
        ...
        \begin{enumerate}[{1.3.}1.]
            ...
            \item Cálculo de modos normales de vibraci\'on
...
%----------------2------------------
    ...
    \begin{enumerate}[{2.}1.]
        ...
        \item Compensación para disminución de modos normales de vibraci\'on
        ...
        \begin{enumerate}[{2.3.}1.]
            ...
            \begin{enumerate}[{2.3.1.}1.]
                ...
                \item C\'alculo del error de posici\'on
            \end{enumerate}
